...
Morris could always use more documentation, whether as part of the
official Morris docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
https://github.com/zyga/morris/issues.
...
3. The pull request should work for Python 2.7, 3.2, 3.3, and 3.4, and for
   PyPy. Check https://travis-ci.org/zyga/morris/pull_requests
